...
public:
  CanvasRadialGradient(CanvasRenderingContext2D* aContext,
    ...
    : CanvasGradient(aContext, aLoader, RADIAL)
...
{
public:
  CanvasLinearGradient(CanvasRenderingContext2D* aContext, mozilla::css::Loader *aLoader,
                       const Point &aBegin, const Point &aEnd)
    : CanvasGradient(aContext, aLoader, LINEAR)
    , mBegin(aBegin)
    , mEnd(aEnd)
  {
  }
